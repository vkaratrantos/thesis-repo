...
def generate_launch_description():
    ...
    # ΑΓΚΥΡΑ (ANCHOR): Συνδέουμε το 'world' με το 'marker_base'
    # Λέμε στο ROS: "Υπάρχει ένα marker 6cm δεξιά από το ρομπότ"
    anchor_tf = Node(
        package='tf2_ros',
        executable='static_transform_publisher',
        name='anchor_tf',
        # x=0, y=-0.06, z=0 | yaw=0, pitch=0, roll=0 | parent='world' | child='marker_base'
    ...
    run_move_group_node = Node(
        ...
        parameters=[
            ...
            moveit_controllers,
            {'use_sim_time': False},
            # ADD THIS TO FORCE MOVEIT TO ONLY USE THESE PIPELINES:
            {'planning_pipelines': ['ompl']} 
        ],
    )
